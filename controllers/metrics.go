...
func newRoleRequestHistogram(clusterNamespace, clusterName string, clusterType libsveltosv1beta1.ClusterType,
...
func programDuration(elapsed time.Duration, clusterNamespace, clusterName, featureID string,
	...
	if featureID == string(libsveltosv1beta1.FeatureRoleRequest) {
